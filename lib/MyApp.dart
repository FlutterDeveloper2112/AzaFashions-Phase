          ...
          body: ListView(
            children: <Widget>[
              ...
              new ListTile(
                ...
                onTap: () {
                  WebEngagePlugin.setUserFirstName('Shravanti');
                  showToast("User FirstName- Shravanti");
                },
              ),
              new ListTile(
                title: Text("Set LastName"),
                onTap: () {
                  WebEngagePlugin.setUserLastName('Sunchu');
                  showToast("LastName Sunchu");
                },
              ),
              new ListTile(
                title: Text("Set UserEmail"),
                onTap: () {
                  WebEngagePlugin.setUserEmail('sunchushravanti5@gmail.com');
                  showToast("Email - sunchushravanti5@gmail.com");
                },
              ),
              new ListTile(
              ...
              new ListTile(
                ...
                onTap: () {
                  WebEngagePlugin.setUserPhone('+918108207528');
              ...
              new ListTile(
                ...
                onTap: () {
                  WebEngagePlugin.setUserHashedPhone(
                      'shrc043b3f9e198ec09041687e4d4e8d');
                  showToast("HashedPhone - s0ec043b3f9e198ec09041687e4d4e8d");
                },
              ),
              new ListTile(
                title: Text("Set UserCompany"),
                onTap: () {
                  WebEngagePlugin.setUserCompany('MyCompany');
