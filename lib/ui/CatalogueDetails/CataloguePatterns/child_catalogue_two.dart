...
class ChildCataloguePatternTwo extends StatelessWidget{
  final List<ChildModelList> items;
  ChildCataloguePatternTwo({Key key, this.items}) : super(key: key);
  @override
...
class ItemDesignState extends State<ItemDesignPage>{
  ...
  @override
  Widget build(BuildContext context) {
    double height= MediaQuery.of(context).size.height<700?  3.45: 3.20;
    return Column(
        children:<Widget> [
          Container(
              color: Colors.white,
