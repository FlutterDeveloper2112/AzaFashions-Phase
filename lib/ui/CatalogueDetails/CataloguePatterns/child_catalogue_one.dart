...
class ChildCataloguePatternOne extends StatelessWidget {
  final List<ChildModelList> items;
  ChildCataloguePatternOne({Key key, this.items}) : super(key: key);
...
class ItemDesignState extends State<ItemDesignPage>{
  ...
  Widget build(BuildContext context) {
    double height= MediaQuery.of(context).size.height<700? 4.3: 3.85;
    return Container(
