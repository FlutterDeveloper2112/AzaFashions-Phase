...
class CashOnDelivery extends StatefulWidget {
  String mobileNo="",callbackURL;
  CashOnDelivery(this.mobileNo,this.callbackURL);
  @override
  _OTPPageState createState() => _OTPPageState();
}

class _OTPPageState extends State<CashOnDelivery> {
  ...
  @override
  void initState() {
    analytics.setCurrentScreen(screenName: "Cash On Delivery");
    super.initState();
  ...
  changeThePage(BuildContext context){
    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) {return ThankYou(widget.callbackURL, "");}));
  }
